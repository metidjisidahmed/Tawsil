...
module.exports={
    ...
    ENDPOINT_EDIT_AD : baseUrl+`/ads/edit.php`,
    ENDPOINT_DELETE_AD : baseUrl+`/ads/requests.php?`,

    ENDPOINT_GET_AD_BY_ID : baseUrl+`/ads/requests.php?`,
    ENDPOINT_SIGNAL_PROFILE : baseUrl+`/signals/requests.php`,
    ...
    ENDPOINT_EDIT_PROFILE : baseUrl + `/users/details.php`
}
